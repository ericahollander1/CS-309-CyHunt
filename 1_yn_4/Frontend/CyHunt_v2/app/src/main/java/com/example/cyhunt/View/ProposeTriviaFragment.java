...
/**This page will allow collaborator users to propose new trivia questions
 * A simple {@link Fragment} subclass.
 * Use the {@link ProposeTriviaFragment#newInstance} factory method to
 * create an instance of this fragment.
 */
public class ProposeTriviaFragment extends Fragment implements CustomVolleyListenerProCreaTrivia {
     ...
     * @return A new instance of fragment ProposeTriviaFragment.
     */
    // TODO: Rename and change types and number of parameters
    public static ProposeTriviaFragment newInstance(String param1, String param2) {
        ProposeTriviaFragment fragment = new ProposeTriviaFragment();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_propose_trivia, container, false);
        ...
        submitButton = (Button)view.findViewById(R.id.proposeTriviaButton);
    ...
    public boolean onSuccess(String s) {
        ...
        builder.setMessage("Trivia cannot be added.").setTitle("Trivia proposal failed");
    ...
    public void onSuccessComplete(String s)
    {
        ...
        {
            AlertDialog.Builder builder = new AlertDialog.Builder(getActivity());
            builder.setMessage("Trivia has been added to proposed trivia pool").setTitle("Trivia proposed!");
            builder.setPositiveButton("Ok", new DialogInterface.OnClickListener() {
                public void onClick(DialogInterface dialog, int id) {
                    // User clicked OK button
                    //nothing happens but the dialog closes
